...
3) ACADLC was never officially supported for the US version,
   only for the international version!
4) In the ZIP the required interpreter ACADLC.EXP is already
   renamed to ACADL.EXP.
5) A version for AutoCAD R12 WIN is available on the ftp-site
...
"It should be noted that you can freely mix compiled and interpreted code in
